...
內完成」，但實作只在段與段之間問一次「還有沒有剩」，問完就放手。2026-09-22 在 300 張卡的合成庫
上逐段計時，抓到兩段還是這樣：`card_lint.scan_vaults` 撥到 1.0 s 實耗 2.07 s、`warm_guard_cache`
撥到「剩下的全部」實耗 3.85 s，整支開場子程序 8.7–9.4 s——宿主 10 s 只剩 1 s 餘裕。
