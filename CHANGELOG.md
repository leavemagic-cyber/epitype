...
- 閘門：run_all 由 50/50 降為 **46/46**（兩支模組 selftest＋三支回歸退役、一支新增）、privacy PASS、corpus 330/330、seeds 15/15 與 5/5、doctor HEALTH PASS 5/5。各 hook selftest 分母更新：pretooluse 73/73、stop 22/22、sessionstart 29/29、precompact 8/8、recall 45/45、dream 30/30。
