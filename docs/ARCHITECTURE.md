...
4. **Search.** `memsearch.py` builds a local trigram FTS index and supports explicit query or prompt-oriented recall. Search is a retrieval aid, not an authority source and not permission to act.
